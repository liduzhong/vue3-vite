...
import { userList, addUser, updateUser, deleteUser, userInfo, batchDeleteUser } from '../apis'
...
const fetchUserList = async () => {
  try {
    ...
    const res = await userList({ ...queryParams, current: pagination.current, pageSize: pagination.pageSize })
  ...
  formRef.value
    ...
    .then(async valid => {
      ...
      try {
        ...
        isEdit.value ? await updateUser(formState.value) : await addUser(formState.value)
